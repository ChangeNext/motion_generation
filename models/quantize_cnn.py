...
class Quantizer_ste(nn.Module):
    def __init__(self, n_e, e_dim, beta, kmeans_init=True, sync_nu=0.2, affine_lr=10.0, affine_groups=8, norm:str='none',replace_freq=20, feature_size = 512):
        super(Quantizer_ste, self).__init__()
    ...
    def forward(self, z):
        ...
        if hasattr(self, 'affine_transform'):
            self.affine_transform.update_running_statistics(z_flattened, codebook)
