...
import models.vqvaer as vqvae
import utils.utils_model as utils_model
import utils.eval_trans as eval_trans
from dataloader import dataset_TM_train
from dataloader import dataset_TM_eval
from dataloader import dataset_tokenize
from options.get_eval_option import get_opt
import models.moe_transformers as trans
...
args.vq_dir= os.path.join("./dataset/KIT-ML" if args.dataname == 'kit' else "/data/dataset/HumanML3D", f'{args.vq_name}')
...
##### ---- Training ---- #####
best_fid, best_iter, best_div, best_top1, best_top2, best_top3, best_matching = 100,0,0,0,0,0,0
...
while nb_iter <= args.total_iter:
    ...
    outputs = trans_encoder(a_indices, feat_clip_text)
    cls_pred = outputs.logits
