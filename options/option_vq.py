...
def get_args_parser():
    ...
    ## output directory 
    parser.add_argument('--out-dir', type=str, default='output_vqvae/', help='output directory')
    parser.add_argument('--results-dir', type=str, default='visual_results/', help='output directory')
    parser.add_argument('--visual-name', type=str, default='baseline', help='output directory')
    parser.add_argument('--exp-name', type=str, default='train_sota_vqvae', help='name of the experiment, will create a file inside out-dir')
    ## other
