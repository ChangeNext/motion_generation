...
def get_args_parser():
    ...
    parser.add_argument('--out_dir', type=str, default='./out/train/', help='output directory')
    parser.add_argument('--resume_pth', type=str, default="/workspace/myvqvae/out/train/621799v3l2ema_reset512",help='path to saved vqvae model')
    parser.add_argument('--window_size', type=int, default=64, help='training motion length')

    ## train
    parser.add_argument('--per_loss', type=str, default="v3")
    ...
    parser.add_argument('--total_iter', default=200000, type=int, help='number of total iterations to run')
    ...
    parser.add_argument('--loss_per', type=float, default= 1 , help='hyper-parameter for the velocity loss')
    parser.add_argument('--recons_loss', type=str, default='l1_smooth', help='reconstruction loss')
    parser.add_argument('--perceptual_loss', type=str, default='l2', help='perceptual loss')
    ...
    ##test
    parser.add_argument('--test_path', default="/workspace/myvqvae/out/train/62103240v3l2ema_reset512", type=str,help='your test pth')
    ## model
    ...
    parser.add_argument('--vq_act', type=str, default='silu', choices = ['relu', 'silu', 'gelu'], help='dataset directory')
    parser.add_argument('--vq_norm', type=str, default="GN", help='dataset directory')
