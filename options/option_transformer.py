...
def get_args_parser():
    ...
    parser.add_argument("--router_aux_loss_coef", type=int, default=1e-2, help="aux_loss")
    parser.add_argument("--router_z_loss_coef", type=int, default=1e-3, help="aux_loss")
    ...
    ## resume
    parser.add_argument("--resume-pth", type=str, default="./checkpoints/pretrained_vqvae/net_best_div.pth", help='resume vq pth')
